...
export const SETTINGS_WINDOW_DEFAULT_WIDTH = 800;
export const SETTINGS_WINDOW_DEFAULT_HEIGHT = 600;
export const SETTINGS_WINDOW_MIN_WIDTH = 600;
export const SETTINGS_WINDOW_MIN_HEIGHT = 500;
